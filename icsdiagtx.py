...
def usage():
        ...
        print("    icscantx -c 0 -i 0x100 -n 1 -t 5 -d 3e00", flush=True)
        ...
        print("    icscantx -c 0 -i 0x7C0 -n 1 -d 100x", flush=True)
        print("                                      | ", flush=True)
        print("                                      x for random hex", flush=True)
        print("    icscantx -c 0 -i 0x7c0 -t 0.1 ", flush=True)
        print("             witout -d fill random hex string", flush=True)
        print("    icscantx -c 0 -i 0x7df ", flush=True)
        print("             witout -d fill random hex string", flush=True)
